...
That should be it. You can now also generate a new QR code for your repo using online tools, then replace the file in `qrcode.png`. And of course, you should now add your apps!
