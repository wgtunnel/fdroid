...
| --- | --- | --- | --- |
| <a href="https://github.com/wgtunnel/android"><img src="fdroid/repo/com.zaneschepke.wireguardautotunnel/en-US/icon.png" alt="WG Tunnel icon" width="36px" height="36px"></a> | [**WG Tunnel**](https://github.com/wgtunnel/android) | A FOSS WireGuard &amp; AmneziaWG Android client with auto-tunneling, lockdown &amp; l... | 5.1.0 (50100) |
<!-- end apps table -->
